...
<!-- [![npm version](https://img.shields.io/npm/v/@formbar/react)](https://www.npmjs.com/package/@formbar/react) -->

React bindings for `@formbar/core` — hooks, renderers, and accessibility wiring.
...
```bash
bun add @formbar/react @formbar/core
# or
npm install @formbar/react @formbar/core
```

**Peer dependencies:** `react` ≥ 18, `@formbar/core`

## Quick Start

```tsx
import { useForm, useField } from "@formbar/react";
...
- [`@formbar/from-schema`](https://www.npmjs.com/package/@formbar/from-schema) — Schema-to-form generation
