 ...
 */
export function capturePartSnapshot(partId: string, pluginId: string, partInstance: unknown): PartSnapshot | null {
 ...
 */
export function restorePartSnapshot(partInstance: unknown, snapshot: PartSnapshot | null | undefined): boolean {
